...
```{r}
country_filter <- crosstalk::filter_checkbox("countryFilter", "Country",
                                             crosstalk_dat, ~country, inline = TRUE)
org_filter <- crosstalk::filter_checkbox("orgFilter", "Organisation",
                                         crosstalk_dat, ~organisation)
crosstalk::bscols(
  list(country_filter, org_filter),
  fun_plt$html_plot,
  spc_plt$html_plot
)
```
