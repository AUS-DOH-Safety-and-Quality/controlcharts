...
vignette: >
  %\VignetteIndexEntry{Aesthetic Customization}
...
To see the full list of available options for a group, you can use the helper functions `spc_default_settings('group_name')` or `funnel_default_settings('group_name')`.
