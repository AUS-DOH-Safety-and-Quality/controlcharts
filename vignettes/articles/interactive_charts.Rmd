...
# Workaround for crosstalk bug which needs 'filter_slider' to be
# first HTML element when working with dates
# Simply create a hidden/'dummy' filter to initialise correct includes
# https://github.com/rstudio/crosstalk/issues/65
dummy_data <- crosstalk::SharedData$new(data.frame(d = as.Date("01/01/1970")))
crosstalk::filter_slider("dummy", "dummy", dummy_data, ~d)
```
